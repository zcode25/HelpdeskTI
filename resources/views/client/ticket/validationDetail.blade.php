  ...
  <div class="container-fluid p-0">
    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="card">
          <div class="card-body">
            <form action="{{ route('client.ticket.validation', $ticket->ticketId) }}" method="POST">
              @csrf
              ...
              <hr />
              <div class="form-floating mb-3">
                <input type="text" class="form-control @error('techId') is-invalid @enderror" id="techId" name="techId" value="{{ old('techId', $ticket->Technician->employee->name) }}" autocomplete="off" readonly="on">
              ...
              <div class="row mb-3">
                <div class="col">
                  <div class="d-grid gap-2">
                    <button type="submit" name="status" value="Done" class="btn btn-success">Selesai</button>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="d-grid gap-2">
                    <button type="submit" name="status" value="Complaint" class="btn btn-danger">Komplain</button>
                  </div>
                </div>
              </div>
            </form>
