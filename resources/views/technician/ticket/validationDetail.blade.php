  ...
  <div class="container-fluid p-0">
    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="card">
          <div class="card-body">
            <form action="{{ route('technician.ticket.validation', $ticket->ticketId) }}" method="POST">
              @csrf
              ...
              <div class="d-grid gap-2">
                <button type="submit" name="status" value="Validation" class="btn btn-primary">Validation</button>
              </div>
            </form>
          </div>
        </div>
