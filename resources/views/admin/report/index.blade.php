      ...
      <div class="container-fluid p-0">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form class="row g-3" action="{{ route('admin.report.target') }}" method="GET">
                  @csrf
                  <div class="col-auto">
                ...
                <table class="table my-0 table-sm" id="myTable">
                    ...
                    @foreach ($tickets as $ticket)
                      ...
                      @else
                        <td class="align-baseline">-</td>
                      @endif
                      <td><a href="{{ route('admin.report.one', $ticket->ticketId) }}" target="_Blank" class="btn btn-primary btn-sm"><i  data-feather="printer"></i> <span class="align-middle"></span></a></td>
										</tr>
                    @endforeach
                  </tbody>
                </table> 
