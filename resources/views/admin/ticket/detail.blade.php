          ...
          <div class="card-body">
            <form action="" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('priority') is-invalid @enderror" id="priority" name="priority" value="{{ old('priority', $ticket->priority) }}" autocomplete="off" readonly="on">
                @error('priority')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
